...
"oui_myspace":https://github.com/NicolasGraph/oui_myspace is a "oui_player":https://github.com/NicolasGraph/oui_player v2+ extension to easily embed "MySpace":https://myspace.go.com/ provided videos in "Textpattern":https://textpattern.com/ powered websites.
...
oui_myspace's minimum requirements:
...
# "Download":https://github.com/NicolasGraph/oui_myspace/releases the compiled plugin file or the source to compile a customized file.
...
# Install oui_myspace:
@$ composer require nicolasgraph/oui_myspace@
...
bc. $ composer update nicolasgraph/oui_myspace
...
bc. $ composer remove nicolasgraph/oui_myspace
...
oui_myspace version 1.0.0-BETA2, Copyright (C) 2018 Nicolas Morand
...
* *oui_myspace v1.0.0-BETA2* (2018-07-05)
